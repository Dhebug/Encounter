...
; Note: header.s (the CRT startup) is implicitly prepended by make.bat before
; all user files, so any .text code placed HERE is dead code: the CRT jumps
; directly to _main and never falls through here.
