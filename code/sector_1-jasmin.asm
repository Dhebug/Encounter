...
#define CMD_Seek                $14     ; FTDOS uses $14: no head load, verify, 6ms stepping
...
__auto_hires
    ...
    lda #ATTRIBUTE_HIRES		; Write hires switch
    sta $bfdf
...
copy_name    
    ...
    lda #0
    sta FDC_rom_control ; Disable ROM (0 works because overlay has precedence over ROM)
