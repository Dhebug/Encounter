...
typedef struct
{
	...
	item_id associated_item;        	// +3 For the item<->container association
    item_flags flags;               	// +4 Special flags on what can be done with the item
...
extern const char gTextErrorAlreadyFull[];      // "Hmm, it's already full"
extern const char gTextErrorMissingContainer[]; // "I don't have that container"
extern const char gTextErrorDropNotHave[];      // "I can only drop what I'm carrying"
extern const char gTextErrorUnknownItem[];      // "I don't know what that is"
extern const char gTextErrorItemNotPresent[];   // "Can't see it here"
