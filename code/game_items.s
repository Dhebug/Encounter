...
#define ITEM_CONTAINER(description,location,flags) .byt <description,>description,location,255,ITEM_FLAG_IS_CONTAINER|flags,0
...
_gItems
    ...
    // Containers
    ITEM_CONTAINER( _gTextItemTobaccoTin  ,e_LOC_LOUNGE           ,ITEM_FLAG_VISIBLE_IN_SCENE)  // e_ITEM_TobaccoTin           
    ITEM_CONTAINER( _gTextItemBucket      ,e_LOC_WELL             ,ITEM_FLAG_VISIBLE_IN_SCENE)  // e_ITEM_Bucket               
    ITEM_CONTAINER( _gTextItemCardboardBox,e_LOC_GREENHOUSE       ,ITEM_FLAG_VISIBLE_IN_SCENE)  // e_ITEM_CardboardBox         
    ITEM_CONTAINER( _gTextItemNet         ,e_LOC_TENNISCOURT      ,ITEM_FLAG_VISIBLE_IN_SCENE)  // e_ITEM_Net           
    ...
    ITEM_NORMAL( _gTextItemSedativePills         ,e_LOC_NONE            ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_SedativePills     
    ...
    ITEM_NORMAL( _gTextItemSilverKnife           ,e_LOC_VEGSGARDEN      ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_SilverKnife          
    ITEM_NORMAL( _gTextItemLadder                ,e_LOC_ORCHARD         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Ladder               
    ITEM_NORMAL( _gTextItemMixTape               ,e_LOC_NONE            ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_MixTape         
    ITEM_NORMAL( _gTextItemAlsatianDog           ,e_LOC_LARGE_STAIRCASE ,ITEM_FLAG_IMMOVABLE)                       // e_ITEM_Dog          
    ITEM_NORMAL( _gTextItemMeat                  ,e_LOC_NONE            ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Meat                 
    ITEM_NORMAL( _gTextItemBread                 ,e_LOC_DININGROOM      ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Bread                
    ITEM_NORMAL( _gTextItemBlackTape             ,e_LOC_CELLAR_WINDOW   ,ITEM_FLAG_DEFAULT)                         // e_ITEM_BlackTape
    ITEM_NORMAL( _gTextItemChemistryBook         ,e_LOC_LIBRARY         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_ChemistryBook        
    ITEM_NORMAL( _gTextItemBoxOfMatches          ,e_LOC_LOUNGE          ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_BoxOfMatches         
    ITEM_NORMAL( _gTextItemSnookerCue            ,e_LOC_GAMESROOM       ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_SnookerCue           
    ...
    ITEM_NORMAL( _gTextItemHandWrittenNote       ,e_LOC_BOXROOM         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_HandWrittenNote          
    ITEM_NORMAL( _gTextItemRope                  ,e_LOC_WELL            ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Rope                 
    ITEM_NORMAL( _gTextItemHandheldGame          ,e_LOC_CHILDBEDROOM    ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_HandheldGame
    ITEM_NORMAL( _gTextItemRollOfToiletPaper     ,e_LOC_TINY_WC         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_ToiletRoll    
    ITEM_NORMAL( _gTextItemHose                  ,e_LOC_FISHPND         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Hose             
    ...
    ITEM_NORMAL( _gTextItemMortarAndPestle       ,e_LOC_KITCHEN         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_MortarAndPestle
    ITEM_NORMAL( _gTextItemAdhesive              ,e_LOC_BOXROOM         ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Adhesive
    ITEM_NORMAL( _gTextItemAcid                  ,e_LOC_NONE            ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Acid
    ...
    ITEM_NORMAL( _gTextItemDriedOutClay          ,e_LOC_CHILDBEDROOM    ,ITEM_FLAG_VISIBLE_IN_SCENE)                // e_ITEM_Clay
