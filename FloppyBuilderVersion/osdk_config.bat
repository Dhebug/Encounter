...
SET OSDKFILE_GAME=game_main score input_system bytestream common game_misc game_data game_text game_utils loader_api irq audio keyboard time display_basic display last_module
