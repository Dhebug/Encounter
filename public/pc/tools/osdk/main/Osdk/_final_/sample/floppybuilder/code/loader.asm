...
; These values are set in bootsectors code, and assume we start by a jmp instruction
	jmp StartUp
fdc_offset           .byt 0
cmd_writesector      .byt 0
cmd_readsector       .byt 0
cmd_seek             .byt 0
cmd_forceinterrupt   .byt 0
fdc_flag_discside    .byt 0
...
StartUp
    ; At this point the boot sector that called us has made sure that the stack pointer is correctly setup,
    ; that all the specific FDC parameters are correct for this type of controller, and that the
    ; processor is not set in BCD mode
#ifdef loader_hires
    ;
    ; Switch to HIRES
    ;
