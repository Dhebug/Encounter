...
PRINT "Fire  - [Space]
PRINT
PRINT CHR$(135);"   ";CHR$(35);" Radar       --> 5 Pts"
PRINT
PRINT CHR$(135);"   ";CHR$(40);" Flying mine --> 1 Pts"
PRINT
PRINT
...
&Move_Fire_Shot
MT=MT+40
IFDEEK(MT-1)<>#2020THEN&Boom
POKEMT,42:GOTO &update_field

&Boom
IF PEEK(MT)=35THEN &boom_radar
IF PEEK(MT)=40THEN &boom_mine
GOTO&boom_common
&boom_radar
SC=SC+5:POKEMT,41:GOTO&boom_common
&boom_mine
SC=SC+1:POKEMT,32:GOTO&boom_common
&boom_common
T=0:SHOOT
PAPER7:PAPER0
