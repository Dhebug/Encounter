...
; Temporary (I hope) defines to compensate for Jede's DSK builder writting stuff in french
#define FileDriveInfo		datas_lecteur
#define FileStartSector		datas_secteur
#define FileStartTrack		datas_piste
#define FileSectorCount		nombre_secteur
#define FileLoadAdressLow	adresse_chargement_low
#define FileLoadAdressHigh	adresse_chargement_high
