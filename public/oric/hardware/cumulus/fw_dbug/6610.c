...
/*
 Common specs of the modules S1D15G10 and PCF8833.
 - Resolution: 130x130
...
http://www.xcore.com/projects/nokia-6100-display-driver-pcf8833-controller

The encoding of 2 pixels is interlaced on 3 bytes:
rrrr gggg RED and GREEN for 1st pixel
bbbb rrrr BLUE of 1st pixel and RED of 2nd pixel
gggg bbbb GREEN and BLUE of 2nd pixel
...
static const rom color_set Colors[_ui_style_count][_element_count]=
{
  {
    // Retromaster default
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x8} },
    { {0x0, 0x0, 0x0},{0xF, 0xF, 0xF} },
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x8} },
    { {0xF, 0xF, 0x0},{0x0, 0x0, 0x8} },
    { {0x0, 0x8, 0x0},{0xF, 0xF, 0xF} },
    { {0x8, 0x0, 0x0},{0xF, 0xF, 0xF} },
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x8} },
    { {0xF, 0xF, 0xF},{0x8, 0x0, 0x0} }
  },

  {
    // Defence Force grey
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x0} },
    { {0x0, 0x0, 0x0},{0x7, 0x7, 0x7} },
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x0} },
    { {0xF, 0xF, 0x0},{0x0, 0x0, 0x0} },
    { {0x0, 0x8, 0x0},{0x7, 0x7, 0x7} },
    { {0x8, 0x0, 0x0},{0x7, 0x7, 0x7} },
    { {0xF, 0xF, 0xF},{0x0, 0x0, 0x0} },
    { {0xF, 0x7, 0x0},{0x1, 0x1, 0x1} }
  }
};

ui_style UiStyle=SETUP_VISUAL;
...
{
  const rom color_set* colors=&Colors[UiStyle][element];
