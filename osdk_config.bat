...
::SET FINAL_TARGET_DISK=D:\Oric\_oricutron_already_configured_\Encounter-WithWindowsEmulator\Game\%OSDKDISK%
...
SET OSDKFILE_GAME=game_main input_system input_utils bytestream common game_misc game_data game_items game_locations game_text game_utils loader_api irq audio keyboard time display_basic display akyplayer last_module
