...
IF EXIST %FINAL_TARGET_DISK%\%OSDKNAME%-%FREQUENCY%*.DSK.HFE  del %FINAL_TARGET_DISK%\%OSDKNAME%-%FREQUENCY%*.DSK.HFE
IF EXIST %FINAL_TARGET_DISK%\%OSDKNAME%-%FREQUENCY%*.DSK.IMD  del %FINAL_TARGET_DISK%\%OSDKNAME%-%FREQUENCY%*.DSK.IMD
...
IF EXIST %FINAL_TARGET_DISK2%\%OSDKNAME%-%FREQUENCY%*.DSK.HFE  del %FINAL_TARGET_DISK2%\%OSDKNAME%-%FREQUENCY%*.DSK.HFE
IF EXIST %FINAL_TARGET_DISK2%\%OSDKNAME%-%FREQUENCY%*.DSK.IMD  del %FINAL_TARGET_DISK2%\%OSDKNAME%-%FREQUENCY%*.DSK.IMD
:EndDeleteCopy
...
IF "%EXPORT_HFE_VERSION%"=="1" (
    ECHO Converting ..\build\%OSDKDISK% into %FINAL_TARGET_DISK%\%OSDKDISK%.hfe
    ..\bin\hxcfe.exe -finput:"..\build\%OSDKDISK%" -conv:HXC_HFE -foutput:"%FINAL_TARGET_DISK%\%OSDKDISK%.hfe" >..\build\hxc_error.txt
)
IF "%EXPORT_IMD_VERSION%"=="1" (
    ECHO Converting ..\build\%OSDKDISK% into %FINAL_TARGET_DISK%\%OSDKDISK%.imd
    ..\bin\hxcfe.exe -finput:"..\build\%OSDKDISK%" -conv:IMD_IMG -foutput:"%FINAL_TARGET_DISK%\%OSDKDISK%.imd" >..\build\hxc_error.txt
)
...
IF "%EXPORT_HFE_VERSION%"=="1" (
    ECHO Converting ..\build\%OSDKDISK% into %FINAL_TARGET_DISK2%\%OSDKDISK%.hfe
    ..\bin\hxcfe.exe -finput:"..\build\%OSDKDISK%" -conv:HXC_HFE -foutput:"%FINAL_TARGET_DISK2%\%OSDKDISK%.hfe" >..\build\hxc_error.txt
)
IF "%EXPORT_IMD_VERSION%"=="1" (
    ECHO Converting ..\build\%OSDKDISK% into %FINAL_TARGET_DISK2%\%OSDKDISK%.imd
    ..\bin\hxcfe.exe -finput:"..\build\%OSDKDISK%" -conv:IMD_IMG -foutput:"%FINAL_TARGET_DISK2%\%OSDKDISK%.imd" >..\build\hxc_error.txt
)
:EndCopy
