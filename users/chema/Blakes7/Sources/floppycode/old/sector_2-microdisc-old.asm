...
wait_drive2
	...
	*/
	...
	; 
	; Command words should only be loaded in the Command Register when the Busy 
	; status bit is off (Status bit 0). The one exception is the Force Interrupt command. 
	...
	; The Status Register indicates whethter the completed command encountered an 
	; error or was fault free. For ease of discussion, commands are divided into four types (I, II, III, IV).
