...
; ORIC PORT:
; Clipping the line should go here -> should generate 
; new (cX1, cY1) (cX2, cY2) pairs of 8-bit clipped vertices
; maybe more than two of them per each one in PLIST,
; so jsr _AddLineASM should be called inside whenever needed.
POLYFILL
.(
         LDY #2           ;Connect the dots...
l2       LDA (POINT),Y
