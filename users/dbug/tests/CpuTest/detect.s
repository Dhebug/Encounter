...
_CurrentCpu	.byt CPU_UNKNOWN

_DetectCPU
.(
	; Start from an unknown version
	lda #CPU_UNKNOWN
	sta _CurrentCpu

    lda     #0
    inc                    ; .byte $1A ; nop on nmos, inc on every cmos
    cmp     #1
    bcc     isNMOS
...
; Check for 65816/65802
    ...
    inc                     ; .byte $1A, A=$02 if 65816/65802 and A=$01 if 65C02/65SC02
    cmp     #2
    beq     is65816
