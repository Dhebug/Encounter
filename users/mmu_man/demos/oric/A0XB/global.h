...
static void set_tfont(char *fnt)
{
	memcpy(((char *)STDCHRTABLE + 32*8), fnt, 8*112);
}

static void set_tfont_alt(char *fnt)
{
	memcpy(((char *)ALTCHRTABLE + 16*8), fnt, 8*112);
}
...
/* hexagones.c */
extern void hexagones_init(void);
extern void hexagones_fini(void);
extern void do_hexagones(void);
extern void hexagones_render_frame(void);
extern void hexagones_render_frame_till_line(short lastline);
...
extern unsigned char DemoInsidePicture[];
extern unsigned char uAlchimie2Picture[];
...
extern void hwt_raster_start();
extern void hwt_raster_stop();
extern void hwt_raster_slice();
...
/* hwmode.c */
/*
#define HW_MODE_T_W	20
#define HW_MODE_T_H	10
#define HW_MODE_T_OX	10
#define HW_MODE_T_OY	((25 - (HW_MODE_T_H)) / 2)
*/
#define HW_MODE_T_W	20
#define HW_MODE_T_H	16
#define HW_MODE_T_OX	0
#define HW_MODE_T_OY	0

#define HW_MODE_W	((HW_MODE_T_W) * 6)
#define HW_MODE_H	((HW_MODE_T_H) * 8)
#define HW_MODE_OX	((HW_MODE_T_OX) * 6)
#define HW_MODE_OY	((HW_MODE_T_OY) * 8)
#define HW_MODE_T_BG	A_BGBLACK
void hw_mode_init_t(void);
void hw_mode_init_h(void);
void hw_mode_init(void);
void hw_mode_fini(void);
void hw_mode_test_win(void);


/* destiny */
void destiny_start(void);
void destiny_slice(void);
void destiny_do(void);
