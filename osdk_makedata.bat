...
%CONVERT% loc_cellar_window_inside_darkened
...
%CONVERT% loc_cellar_window_inside_cleared
...
%CONVERT% view_cellar_window_outside_cleared
%CONVERT% view_cellar_window_outside_darkened
